...
In deze [vulcano plot](figuren/vulcano%20plot.png))vulcano plot zijn de genen met rood aangegeven die een p-waarde hebben van <0,05 en een log2 fold change hebben van kleiner dan -1 en groter dan 1.
