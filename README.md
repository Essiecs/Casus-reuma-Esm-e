...
De eerste stap in het proces is het indexeren van de reads, deze stap is niet noodzakelijk maar scheelt wel tijd. Vervolgens worden de reads gemapt. [indexeren+mappen](scripts/indexeren%20%2B%20mappen.R)
